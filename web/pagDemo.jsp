            ...
            <div class="col-lg-3 row-content">
                <div class="content-box">
                    <div class="back">
                        ...
                        <input type="button" value="ayuda" onclick="window.open('modDemo.jsp','','width=300, height=300, scrollbars=1')">
                        <a href="javascript:window.opener.fr1.tcod.value='control?opc=3&cod=';window.close()">Select</a>
                    </div>
    ...
    <script>
        ...
        $.get("control", consulta, (response) => {
            ...
            misDatos.forEach(midato => {
                ...
                template += "<td>  <a href='javascript:window.opener.fr1.cod_prod.value='control?opc=2&cod=" + midato.codProd + ";window.open()''></a> | <a href='control?opc=3&cod=" + midato.codProd + "'></a>";
                template += "</tr>";
            });

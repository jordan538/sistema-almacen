                ...
                <div class="row">         
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label">Unidad:</label>
                            <div class="form-group">
                                <!--<input id="tipo-a" class="form-check-input" type="checkbox" name="pro"> Nacional    -->
                                <!--<input id="tipo-b" class="form-check-input" type="checkbox" name="pro"> Extranjero-->
        ...
        function listado(valor = '') {
            ...
            function llenarModal(response) {
                ...
                /*if (response.umProd === 'N') {
                    ...
                    tipoa.attr('checked', false);
                }
                if (response.umProd === 'P') {
                    tipob.attr('checked', true);
                }else{
                    tipob.attr('checked', false);
                }*/
